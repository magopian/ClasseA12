...
{
	if (region.aA.W === region.aL.W)
	{
		return 'on line ' + region.aA.W;
	}
	return 'on lines ' + region.aA.W + ' through ' + region.aL.W;
}
...
var _Http_toTask = F2(function(request, maybeProgress)
{
	return _Scheduler_binding(function(callback)
	{
		...
		xhr.addEventListener('load', function() {
			callback(_Http_handleResponse(xhr, request.ar.a));
		});

		try
		{
			xhr.open(request.aw, request.bN, true);
		}
		catch (e)
		{
...
function _Http_toResponse(xhr)
{
	return {
		bN: xhr.responseURL,
		bI: { bn: xhr.status, aj: xhr.statusText },
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bv: 'hidden', T: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bv: 'mozHidden', T: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bv: 'msHidden', T: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bv: 'webkitHidden', T: 'webkitvisibilitychange' }
		: { bv: 'hidden', T: 'visibilitychange' };
}
...
var author$project$Data$Kinto$NotRequested = {$: 0};
var author$project$Data$Kinto$emptyVideo = {aq: '', aR: '', as: '', aD: ''};
var author$project$Page$Participate$init = function (session) {
	return _Utils_Tuple2(
		{z: author$project$Data$Kinto$emptyVideo, t: author$project$Data$Kinto$NotRequested, al: 0, ag: elm$core$Maybe$Nothing},
		elm$core$Platform$Cmd$none);
};
...
var elm$http$Http$expectString = elm$http$Http$expectStringResponse(
	function (response) {
		return elm$core$Result$Ok(response.bi);
	});
...
var elm$http$Http$getString = function (url) {
	return elm$http$Http$request(
		{bi: elm$http$Http$emptyBody, ar: elm$http$Http$expectString, o: _List_Nil, aw: 'GET', aC: elm$core$Maybe$Nothing, bN: url, aE: false});
};
	...
	function (maybeRoute, model) {
		...
		if (maybeRoute.$ === 1) {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{q: author$project$Main$NotFound}),
				elm$core$Platform$Cmd$none);
		} else {
			switch (maybeRoute.a) {
				case 0:
...
var elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {x: frag, A: params, v: unvisited, r: value, C: visited};
	});
	...
	return A2(
		...
		_Utils_update(
			url,
			{
				...
				bG: A2(elm$core$Maybe$withDefault, '', url.aN)
			}));
};
var author$project$Main$init = F3(
	function (flags, url, navKey) {
		var session = {bO: author$project$Data$Session$Fetching};
		return A2(
			...
			author$project$Route$fromUrl(url),
			{
				H: false,
				ax: navKey,
				q: author$project$Main$HomePage(
					function (_n0) {
						var model = _n0.a;
						return model;
					}(
...
var author$project$Data$Session$Video = F6(
	function (description, link, player, pubDate, thumbnail, title) {
		return {aq: description, aU: link, aZ: player, a2: pubDate, bc: thumbnail, aD: title};
	});
...
var author$project$Page$Participate$AttachmentSent = function (a) {
	return {$: 7, a: a};
};
var author$project$Page$Participate$ProgressUpdated = function (a) {
	return {$: 6, a: a};
};
var author$project$Page$Participate$VideoObjectUrlReceived = function (a) {
	return {$: 5, a: a};
};
var elm$json$Json$Decode$value = _Json_decodeValue;
var author$project$Ports$parsedVideoList = _Platform_incomingPort('parsedVideoList', elm$json$Json$Decode$value);
var author$project$Ports$progressUpdate = _Platform_incomingPort('progressUpdate', elm$json$Json$Decode$value);
var author$project$Ports$videoObjectUrl = _Platform_incomingPort('videoObjectUrl', elm$json$Json$Decode$value);
var author$project$Ports$videoSubmitted = _Platform_incomingPort('videoSubmitted', elm$json$Json$Decode$value);
...
var author$project$Main$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				author$project$Ports$parsedVideoList(
				...
				switch (_n0.$) {
					...
					case 2:
						return elm$core$Platform$Sub$batch(
							A2(
								elm$core$List$map,
								elm$core$Platform$Sub$map(author$project$Main$ParticipateMsg),
								_List_fromArray(
									[
										author$project$Ports$videoObjectUrl(author$project$Page$Participate$VideoObjectUrlReceived),
										author$project$Ports$progressUpdate(author$project$Page$Participate$ProgressUpdated),
										author$project$Ports$videoSubmitted(author$project$Page$Participate$AttachmentSent)
									])));
					case 3:
						return elm$core$Platform$Sub$none;
					default:
...
var author$project$Data$Kinto$Failed = function (a) {
	return {$: 3, a: a};
};
var author$project$Data$Kinto$Received = function (a) {
	return {$: 2, a: a};
};
var author$project$Data$Kinto$Requested = {$: 1};
var author$project$Page$Participate$NewVideoSubmitted = function (a) {
	return {$: 2, a: a};
};
...
var author$project$Ports$submitVideo = _Platform_outgoingPort(
	'submitVideo',
	function ($) {
		var a = $.a;
		var b = $.b;
...
var author$project$Ports$videoSelected = _Platform_outgoingPort('videoSelected', elm$json$Json$Encode$string);
...
var elm$http$Http$expectJson = function (decoder) {
	return elm$http$Http$expectStringResponse(
		function (response) {
			var _n0 = A2(elm$json$Json$Decode$decodeString, decoder, response.bi);
			if (_n0.$ === 1) {
...
var lukewestby$elm_http_builder$HttpBuilder$requestWithMethodAndUrl = F2(
	function (method, url) {
		return {
			...
			ar: elm$http$Http$expectStringResponse(
				function (_n0) {
...
var lukewestby$elm_http_builder$HttpBuilder$withExpect = F2(
	function (expect, builder) {
		return {bi: builder.bi, m: builder.m, ar: expect, o: builder.o, aw: builder.aw, l: builder.l, aC: builder.aC, bN: builder.bN, aE: builder.aE};
	});
...
var Kinto$elm_kinto$Kinto$create = F3(
	function (resource, body, clientInstance) {
		return A2(
			...
			elm$http$Http$expectJson(resource.I),
			A2(
				...
				A2(
					...
					lukewestby$elm_http_builder$HttpBuilder$post(
						A2(Kinto$elm_kinto$Kinto$endpointUrl, clientInstance.w, resource.au)))));
	});
...
var Kinto$elm_kinto$Kinto$ErrorDetail = F4(
	function (errno, message, code, error) {
		return {bn: code, bp: errno, bq: error, aj: message};
	});
...
var Kinto$elm_kinto$Kinto$extractError = function (error) {
	switch (error.$) {
		case 3:
			var status = error.a.bI;
			var body = error.a.bi;
			return A3(Kinto$elm_kinto$Kinto$extractKintoError, status.bn, status.aj, body);
		case 4:
			var str = error.a;
			var status = error.b.bI;
			var body = error.b.bi;
			return A3(Kinto$elm_kinto$Kinto$ServerError, status.bn, status.aj, 'failed decoding json: ' + (str + ('\n\nBody received from server: ' + body)));
		default:
			var anyError = error;
...
var lukewestby$elm_http_builder$HttpBuilder$requestUrl = function (builder) {
	var encodedParams = lukewestby$elm_http_builder$HttpBuilder$joinUrlEncoded(builder.l);
	var fullUrl = elm$core$String$isEmpty(encodedParams) ? builder.bN : (builder.bN + ('?' + encodedParams));
	return fullUrl;
};
	...
	return elm$http$Http$request(
		{
			...
			aw: builder.aw,
			aC: builder.aC,
			bN: lukewestby$elm_http_builder$HttpBuilder$requestUrl(builder),
			aE: builder.aE
		});
};
...
var lukewestby$elm_http_builder$HttpBuilder$withQueryParams = F2(
	function (queryParams, builder) {
		return _Utils_update(
			builder,
			{
				l: _Utils_ap(builder.l, queryParams)
			});
	});
...
var author$project$Data$Kinto$encodeData = function (video) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'description',
				elm$json$Json$Encode$string(video.aq)),
				_Utils_Tuple2(
				'title',
				elm$json$Json$Encode$string(video.aD)),
				_Utils_Tuple2(
				'keywords',
				elm$json$Json$Encode$string(video.as))
			]));
};
...
var author$project$Request$KintoUpcoming$client = A2(
	Kinto$elm_kinto$Kinto$client,
	'https://kinto.agopian.info/v1/',
	A2(Kinto$elm_kinto$Kinto$Basic, 'classea12', 'notasecret'));
...
var Kinto$elm_kinto$Kinto$Resource = F4(
	function (itemEndpoint, listEndpoint, itemDecoder, listDecoder) {
		return {I: itemDecoder, V: itemEndpoint, at: listDecoder, au: listEndpoint};
	});
...
var author$project$Data$Kinto$Video = F4(
	function (id, title, keywords, description) {
		return {aq: description, aR: id, as: keywords, aD: title};
	});
var author$project$Data$Kinto$videoDecoder = A5(
	elm$json$Json$Decode$map4,
	author$project$Data$Kinto$Video,
	A2(elm$json$Json$Decode$field, 'id', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'description', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'title', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'keywords', elm$json$Json$Decode$string));
var author$project$Request$KintoUpcoming$recordResource = A3(Kinto$elm_kinto$Kinto$recordResource, 'classea12', 'upcoming', author$project$Data$Kinto$videoDecoder);
var author$project$Request$KintoUpcoming$submitVideo = F2(
	function (video, message) {
		return A2(
			Kinto$elm_kinto$Kinto$send,
			message,
			A3(
				Kinto$elm_kinto$Kinto$create,
				author$project$Request$KintoUpcoming$recordResource,
				author$project$Data$Kinto$encodeData(video),
				author$project$Request$KintoUpcoming$client));
	});
		...
		switch (msg.$) {
			...
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{t: author$project$Data$Kinto$Requested}),
					A2(author$project$Request$KintoUpcoming$submitVideo, model.z, author$project$Page$Participate$NewVideoSubmitted));
			case 2:
				if (!msg.a.$) {
					var video = msg.a.a;
					return _Utils_Tuple2(
						model,
						author$project$Ports$submitVideo(
							_Utils_Tuple2('video', video.aR)));
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								t: author$project$Data$Kinto$Failed(error)
							}),
						elm$core$Platform$Cmd$none);
				}
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{t: author$project$Data$Kinto$NotRequested}),
					elm$core$Platform$Cmd$none);
			case 4:
				return _Utils_Tuple2(
					model,
					author$project$Ports$videoSelected('video'));
			case 5:
				var value = msg.a;
				var objectUrl = A2(elm$json$Json$Decode$decodeValue, elm$json$Json$Decode$string, value);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							ag: elm$core$Result$toMaybe(objectUrl)
						}),
					elm$core$Platform$Cmd$none);
			case 6:
				var value = msg.a;
				var percentage = A2(
					...
					elm$core$Result$toMaybe(
						A2(elm$json$Json$Decode$decodeValue, elm$json$Json$Decode$int, value)));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{al: percentage}),
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							z: author$project$Data$Kinto$emptyVideo,
							t: author$project$Data$Kinto$Received(model.z),
							ag: elm$core$Maybe$Nothing
						}),
					elm$core$Platform$Cmd$none);
		}
	});
var author$project$Ports$parseRSS = _Platform_outgoingPort('parseRSS', elm$json$Json$Encode$string);
var author$project$Request$Vimeo$errorToString = function (error) {
	switch (error.$) {
		...
		case 3:
			...
			return 'HTTP error ' + elm$core$String$fromInt(response.bI.bn);
		default:
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aN: fragment, aQ: host, bG: path, a_: port_, a1: protocol, a3: query};
	});
				...
				switch (_n0.a.$) {
					...
					case 8:
						if (!_n0.a.a.$) {
							...
							return _Utils_Tuple2(
								model,
								author$project$Ports$parseRSS(rss));
						} else {
							var error = _n0.a.a.a;
								...
								_Utils_update(
									model,
									{
										f: _Utils_update(
											modelSession,
											{
												bO: author$project$Data$Session$Error(
								...
								_Utils_update(
									model,
									{
										f: _Utils_update(
											modelSession,
											{
												bO: author$project$Data$Session$Received(videoList)
											})
									}),
								elm$core$Platform$Cmd$none);
						} else {
...
var author$project$Page$Home$UpdateSearch = function (a) {
	return {$: 0, a: a};
};
var author$project$Page$Home$HideVideo = {$: 2};
var author$project$Page$Home$ShowVideo = function (a) {
	return {$: 1, a: a};
};
...
var author$project$Page$Home$stringProperty = F2(
	function (name, value) {
		return A2(
...
var author$project$Page$Home$viewVideo = F2(
	function (_n0, video) {
		var activeVideo = _n0.R;
		var active = A2(
			elm$core$Maybe$withDefault,
			false,
			A2(
				elm$core$Maybe$map,
				elm$core$Basics$eq(video),
				activeVideo));
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							elm$html$Html$Events$onClick(author$project$Page$Home$HideVideo)
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$src(video.aZ),
											elm$html$Html$Attributes$title('Partie 2 : am&eacute;nager sa classe pour co-enseigner.'),
											A2(author$project$Page$Home$stringProperty, 'scrolling', 'no'),
											A2(author$project$Page$Home$stringProperty, 'frameborder', '0'),
											A2(author$project$Page$Home$stringProperty, 'allowfullscreen', 'true')
										]),
									_List_Nil)
								])),
							A2(
					...
					_List_fromArray(
						[
							...
							author$project$Page$Home$ShowVideo(video))
						]),
					_List_fromArray(
						[
							A2(
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															elm$html$Html$Attributes$src(video.bc),
															elm$html$Html$Attributes$alt('Thumbnail of the video titled: ' + video.aD)
														]),
													_List_Nil)
												]))
										])),
...
var author$project$Page$Home$viewVideoList = F2(
	function (model, videoList) {
		var search = model.an;
		var filteredVideoList = A2(
			elm$core$List$filter,
			function (video) {
				return A2(elm$core$String$contains, search, video.aD);
			},
			videoList);
		return _List_fromArray(
			[
									...
									[
										...
										_List_fromArray(
											[
												...
												elm$html$Html$Events$onInput(author$project$Page$Home$UpdateSearch)
											]),
										_List_Nil)
									])),
								A2(
				...
				A2(
					elm$core$List$map,
					author$project$Page$Home$viewVideo(model),
					filteredVideoList))
			]);
	});
		...
		return _Utils_Tuple2(
			...
			function () {
				...
				switch (_n0.$) {
					...
					case 1:
						var videoList = _n0.a;
						return A2(author$project$Page$Home$viewVideoList, model, videoList);
					default:
						var error = _n0.a;
						return _List_fromArray(
							[
...
var Kinto$elm_kinto$Kinto$errorToString = function (error) {
	switch (error.$) {
		...
		case 1:
			...
			var message = error.b;
			var detail = error.c;
			return elm$core$String$fromInt(status) + (' ' + (message + (' ' + detail.aj)));
		default:
			var httpError = error.a;
			return 'NetworkError';
	}
};
var author$project$Page$Participate$DiscardNotification = {$: 3};
var author$project$Page$Participate$displayKintoData = function (kintoData) {
	switch (kintoData.$) {
		case 3:
			var error = kintoData.a;
			return A2(
				elm$html$Html$div,
				_List_fromArray(
					[
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Events$onClick(author$project$Page$Participate$DiscardNotification)
							]),
						_List_Nil),
						elm$html$Html$text(
						Kinto$elm_kinto$Kinto$errorToString(error))
					]));
		case 2:
			return A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_Nil),
						elm$html$Html$text('Merci pour cette vidéo ! Vous pouvez en poster une autre ou '),
						A2(
						elm$html$Html$a,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								elm$html$Html$text('retourner à la liste de vidéos')
							]))
					]));
		default:
...
var author$project$Page$Participate$SubmitNewVideo = {$: 1};
var author$project$Page$Participate$UpdateVideoForm = function (a) {
	return {$: 0, a: a};
};
var author$project$Page$Participate$VideoSelected = {$: 4};
...
var author$project$Page$Participate$displayVideo = function (maybeVideoObjectUrl) {
	if (!maybeVideoObjectUrl.$) {
		var videoObjectUrl = maybeVideoObjectUrl.a;
		return A2(
			elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$src(videoObjectUrl),
...
var author$project$Page$Participate$formInput = F7(
	function (input, id, label, placeholder, value, onInput, isVisible) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
...
var author$project$Page$Participate$onFileSelected = function (msg) {
	return A2(
		elm$html$Html$Events$on,
		'change',
		elm$json$Json$Decode$succeed(author$project$Page$Participate$VideoSelected));
};
...
var author$project$Page$Participate$displaySubmitVideoForm = function (_n0) {
	var newVideo = _n0.z;
	var newVideoKintoData = _n0.t;
	var videoObjectUrl = _n0.ag;
	var percentage = _n0.al;
	var videoSelected = !_Utils_eq(videoObjectUrl, elm$core$Maybe$Nothing);
	return A2(
		elm$html$Html$form,
		_List_fromArray(
			[
				elm$html$Html$Events$onSubmit(author$project$Page$Participate$SubmitNewVideo)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								author$project$Page$Participate$displayVideo(videoObjectUrl),
								A2(
								elm$html$Html$div,
								_List_fromArray(
									[
											...
											[
												...
												_List_fromArray(
													[
														...
														author$project$Page$Participate$onFileSelected(author$project$Page$Participate$VideoSelected)
													]),
												_List_Nil),
												A2(
												elm$html$Html$span,
				...
				newVideo.aD,
				function (title) {
					return author$project$Page$Participate$UpdateVideoForm(
						_Utils_update(
							newVideo,
							{aD: title}));
				},
							...
							[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Attributes$disabled(newVideo.aD === '')
									]),
								_List_fromArray(
									[
										elm$html$Html$text('Soumettre cette vidéo')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_Utils_Tuple2(
								'is-active',
								_Utils_eq(newVideoKintoData, author$project$Data$Kinto$Requested))
							]))
					]),
				_List_fromArray(
					[
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														elm$html$Html$text('Envoi de la vidéo en cours')
													]))
											])),
										A2(
										...
										_List_fromArray(
											[
												elm$html$Html$text('Veuillez patienter...'),
												A2(
												elm$html$Html$progress,
												_List_fromArray(
													[
														elm$html$Html$Attributes$class('progress is-large is-success'),
		...
		return _Utils_Tuple2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							author$project$Page$Participate$displayKintoData(model.t),
							elm$html$Html$text('Vous aimeriez avoir l\'avis de vos collègues sur une problématique ou souhaitez poster une vidéo pour aider le collectif, vous êtes au bon endroit !'),
							author$project$Page$Participate$displaySubmitVideoForm(model)
						]))
				]));
	});
...
var author$project$Views$Page$Config = F4(
	function (session, isMenuActive, toggleMenu, activePage) {
		return {aF: activePage, H: isMenuActive, f: session, bd: toggleMenu};
	});
...
var author$project$Views$Page$viewHeader = function (_n0) {
	var activePage = _n0.aF;
	var isMenuActive = _n0.H;
	var toggleMenu = _n0.bd;
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$src('./logo.jpg'),
									...
									[
										...
										_List_fromArray(
											[
												...
												_Utils_Tuple2('is-active', isMenuActive)
											])),
										elm$html$Html$Events$onClick(toggleMenu)
									]),
								_List_fromArray(
									[
...
var author$project$Views$Page$frame = F2(
	function (config, _n0) {
		...
		return {
			...
			aD: title + ' | Classe à 12'
		};
	});
var elm$virtual_dom$VirtualDom$map = _VirtualDom_map;
var elm$html$Html$map = elm$virtual_dom$VirtualDom$map;
var author$project$Main$view = function (model) {
	var pageConfig = A3(author$project$Views$Page$Config, model.f, model.H, author$project$Main$BurgerClicked);
	var mapMsg = F2(
		function (msg, _n1) {
			var title = _n1.a;
			var content = _n1.b;
...
var author$project$Main$main = elm$browser$Browser$application(
	{by: author$project$Main$init, bD: author$project$Main$UrlChanged, bE: author$project$Main$UrlRequested, bK: author$project$Main$subscriptions, bM: author$project$Main$update, bP: author$project$Main$view});
